...
- **Optimal Chunk Size**: 180 characters
- **Optimal Overlap**: 50 characters
- **Average Compression Ratio**: 2.74

## Key Insights from Evaluation

### 1. Tokenizer Performance

The **BERT WordPiece** tokenizer consistently outperformed GPT-2 and T5 on this scientific corpus. It achieved a higher compression ratio (~2.7) while maintaining better token consistency (lower standard deviation in tokens per chunk), which is critical for stable retrieval scores.

### 2. Optimal Chunk Size (180 characters)

A chunk size of **180 characters** was found to be the "sweet spot."
